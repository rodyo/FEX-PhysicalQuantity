 classdef UnitOfMeasurement 
    ...
    methods
        ...
        function obj = UnitOfMeasurement(varargin)
            ...
            % Parse input argument as P/V pairs. These are either strings, or 
            % cellstrings, in which case an object array will be created            
                    ...
                    switch p
                        ...
                        case 'system'                            
                            assert(isa(v, 'SystemOfUnits'),...
                                   ...
                                   'System of units must be specified with a ',...
                                   '''SystemOfUnits'' enumeration class.']);
                            obj(ii).system = v;
