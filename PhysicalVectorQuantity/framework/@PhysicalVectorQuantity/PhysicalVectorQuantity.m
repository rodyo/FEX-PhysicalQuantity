        ...
        function obj = PhysicalVectorQuantity(varargin)
            ...
            try
                ...
                assert(isa(obj.datatype, 'meta.class'),...
                       ...
                       'Internal error; a PhysicalQuantityVector'' ''datatype'' property must ',...
                       'be a meta.class.']);            
                ...
                assert(all(cellfun(@(x) isa(x, 'PhysicalQuantityInterface'), varargin)),...
                ...
                assert(isa(varargin{1}, obj.datatype.Name),...
                       ...
                       'A %s is a vector of 3 %ss; received at least one ''%s''.',...
                ...
                switch nargin
                    ...
                    case 1
                        ...
                        assert(numel(pq)==3,...
                               [class(obj) ':invalid_argument'], [...
                               'When calling %s with a a single argument, that argument must be ',...
                               'a 3-element PhysicalQuantity.'],...
                                class(obj));                    
                    ...
                    % 3 arguments: each argument is an N-element subclass of PhysicalQuantity (all the
                    % same subclass)
                    case 3
                        ...
                        assert(isequal(class(pqx),class(pqy),class(pqz)),...
                               [class(obj) ':invalid_argument'], [...
                               'All 3 input arguments must have the same class. Received a "%s", a ',...
                               '"%s" and a "%s".'],...
                               class(pqx), class(pqy), class(pqz));

                        assert(isequal(size(pqx),size(pqy),size(pqz)),...
                               [mfilename('class') ':invalid_argument'], ...
                               'All 3 input arguments must have the same dimensions.');
